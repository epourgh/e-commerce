...
class StripeUser(models.Model):
    ...
    cuid = models.CharField(max_length=200, null=True, blank=True)
...
class Refund(models.Model):
    ...
    stripeUser = models.ForeignKey(StripeUser, on_delete=models.SET_NULL, null=True)
    ...
    storeResponse = models.CharField(max_length=200, null=True, blank=True)

    def __str__(self):
        return str(self.requestedAt)
